                ...
                <div class="box box-primary card">
                    ...
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            ...
                            @endif
                            <li class="active"><a href="{{url('entretiens/'.$e->id.'/comments')}}">Commentaire</a></li>
                        </ul>
                        <div class="tab-content">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> 
                                                    ...
                                                    <a href="javascript:void(0)" onclick="return chmComment.edit({e_id: {{$e->id}} , id: {{$c->id}} })" class="btn-warning icon-fill"> <i class="glyphicon glyphicon-pencil"></i> </a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                            ...
                            <a onclick="return chmComment.create()" data-id="{{$e->id}}" class="btn btn-success addBtn">Ajouter un commentaire</a>
                        </div>
                    </div>
                </div>
            </div>
