...
<div class="content">
    ...
    <div class="form-group">
        <div class="col-md-6">
            ...
            <input type="text" name="date" class="form-control" id="datepicker" placeholder="Choisir une date" value="{{isset($e->date) ? Carbon\Carbon::parse($e->date)->format('d-m-Y') : null }}" readonly="">
        </div>
        <div class="col-md-6">
            <label for="date_limit" class="control-label">Date limite</label>
            <input type="text" name="date_limit" class="form-control" id="datepicker" placeholder="Choisir une date" value="{{isset($e->date_limit) ? Carbon\Carbon::parse($e->date_limit)->format('d-m-Y') : null }}" readonly="">
        </div>
    </div>
    <div class="form-group">
        <div class="col-md-12">
