                                            ...
                                            <div class="form-group">
                                                ...
                                                @elseif($q->type == "slider")
                                                    <div class="disabled" style="margin-top: 30px;">
                                                        <input type="text" class="slider" data-provide="slider" data-slider-min="1" data-slider-max="5" data-slider-step="1" data-slider-value="{{App\Answer::getCollAnswers($q->id, $user->id, $e->id) ? App\Answer::getCollAnswers($q->id, $user->id, $e->id)->answer : '' }}" data-slider-tooltip="always">
                                                    </div>
                                                @endif
                                            </div>
                                        @empty
                                    ...
                                    <div class="panel panel-info">
                                        ...
                                        @forelse($g->questions as $q)
                                            ...
                                            @if($q->parent == null)
                                                ...
                                                @elseif($q->type == "slider")
                                                    <div class="disabled" style="margin-top: 30px;">
                                                        <input type="text" class="slider" data-provide="slider" data-slider-min="1" data-slider-max="5" data-slider-step="1" data-slider-value="{{ App\Answer::getMentorAnswers($q->id, $user->id, $e->id) ? App\Answer::getMentorAnswers($q->id, $user->id, $e->id)->mentor_answer : ''}}" data-slider-tooltip="always">
                                                    </div>
                                                @endif
                                            </div>
