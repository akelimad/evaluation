                        ...
                        <tr>
                          ...
                          <td class="text-center">
                            <span
                                ...
                                data-toggle="tooltip"
                                title="{{App\Entretien::answeredMentor($e->id, Auth::user()->id, App\User::getMentor(Auth::user()->id)->id) ? 'Validée par mentor le '.Carbon\Carbon::parse(App\Entretien::answered($e->id, Auth::user()->id)->mentor_updated_at)->format('d/m/Y à H:i') :'Pas encore validée par votre mentor'}}"> </span>
                          </td>
                        </tr>
                      @endforeach
                      </tbody>
                            ...
                            <tr>
                              ...
                              <td class="text-center">
                                <span
                                    ...
                                    data-toggle="tooltip"
                                    title="{{App\Entretien::answered($en->id, $coll->id) ? 'Remplie le '.Carbon\Carbon::parse(App\Entretien::answered($en->id, $coll->id)->user_updated_at)->format('d/m/Y H:i') :'Pas encore rempli par '.$coll->name }}"> </span>
                              ...
                              <td class="text-center">
                                <span
                                    ...
                                    data-toggle="tooltip"
                                    title="{{App\Entretien::answeredMentor($en->id, $coll->id, Auth::user()->id) ? 'Validée par mentor le '.Carbon\Carbon::parse(App\Entretien::answeredMentor($en->id, $coll->id, Auth::user()->id)->mentor_updated_at)->format('d/m/Y H:i') :'Veuillez valider l\'évaluation de '.$coll->name}}"> </span>
