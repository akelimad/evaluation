...
<div class="content commentsForm">
    ...
    <div id="addLine-wrap">
        <div class="form-group" >
            <label class="col-md-3 control-label">Fonction : <span class="badge"> </span></label>
            <div class="col-md-8">
                <input type="text" name="titles[]" id="title" class="form-control" value="{{ $fonction->title }}" required>
            </div>
