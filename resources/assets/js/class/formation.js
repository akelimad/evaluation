...
export default class chmFormation {
  ...
  static create () {
    ...
    console.log(eid)
    window.chmModal.show({type: 'GET', url: window.chmSite.url('entretiens/' + eid + '/formations/create')}, {
      form: {
        class: 'allInputsFormValidation form-horizontal',
        callback: 'chmFormation.store'
      },
      footer: {
        label: 'Sauvegarder'
      },
  ...
  static edit (params) {
    window.chmModal.show({type: 'GET', url: window.chmSite.url('entretiens/' + params.e_id + '/formations/' + params.id + '/edit')}, {
      form: {
        class: 'allInputsFormValidation form-horizontal',
        callback: 'chmFormation.store'
      },
  ...
  static store (event) {
    ...
    var ajaxParams = {
      id: id,
      type: 'POST',
      url: window.chmSite.url('entretiens/' + eid + '/formations/store'),
      data: data,
      processData: false,
      contentType: false,
      cache: false,
